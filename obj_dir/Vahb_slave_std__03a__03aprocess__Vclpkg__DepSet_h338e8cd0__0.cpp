...
void Vahb_slave_std__03a__03aprocess__Vclpkg::__VnoInFunc_self(VlProcessRef vlProcess, Vahb_slave__Syms* __restrict vlSymsp, VlClassRef<Vahb_slave_std__03a__03aprocess> &self__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vahb_slave_std__03a__03aprocess__Vclpkg::__VnoInFunc_self\n"); );
    // Body
    VlClassRef<Vahb_slave_std__03a__03aprocess> p;
    p = VL_NEW(Vahb_slave_std__03a__03aprocess, vlSymsp);
...
void Vahb_slave_std__03a__03aprocess::__VnoInFunc_suspend(Vahb_slave__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vahb_slave_std__03a__03aprocess::__VnoInFunc_suspend\n"); );
    // Body
...
VlCoroutine Vahb_slave_std__03a__03aprocess::__VnoInFunc_await(Vahb_slave__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vahb_slave_std__03a__03aprocess::__VnoInFunc_await\n"); );
    // Init
    VL_KEEP_THIS;
...
Vahb_slave_std__03a__03aprocess::Vahb_slave_std__03a__03aprocess(Vahb_slave__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vahb_slave_std__03a__03aprocess::new\n"); );
    // Init
    _ctor_var_reset(vlSymsp);
}

void Vahb_slave_std__03a__03aprocess::_ctor_var_reset(Vahb_slave__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vahb_slave_std__03a__03aprocess::_ctor_var_reset\n"); );
    // Body
